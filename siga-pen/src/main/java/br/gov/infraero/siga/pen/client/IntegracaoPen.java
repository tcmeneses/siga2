...
public class IntegracaoPen {
    ...
    private static void uploadArquivoBinario(InteroperabilidadePEN ws, long ticket) throws InteroperabilidadeException_Exception, RemoteException {
        ...
        dadosUpload.setHashDoComponenteDigital("WZAbPFL8xC5mdzJyh3BwXqPjeqeYgfxC6Ubc5ylaW3M=");
        ...
        dadosUpload.setConteudoDoComponenteDigital(new DataHandler(new ByteArrayDataSource("Conteudo teste Infraero".getBytes(), "text/plain")));
...
//		cabecalho.setNRE("0000000142722014");
        ...
        processo.setProdutor(produtor);
        processo.setDescricao("Documento de teste Infraero");

        ComponenteDigital arquivo1 = new ComponenteDigital();
        arquivo1.setNome("Arquivo1");

        Hash hash = new Hash();
        //hash.setValue(Base64.decode("l9G0iRAn39p9HM9idu/C8tiZMV5LmmLOoS8N/0SbNHs=").toString());
        hash.setValue("WZAbPFL8xC5mdzJyh3BwXqPjeqeYgfxC6Ubc5ylaW3M=");
        hash.setAlgoritmo("SHA256");
        arquivo1.setHash(hash);
        arquivo1.setTipoDeConteudo(TipoDeConteudo.TXT);
        arquivo1.setMimeType(MimeType.TEXT_PLAIN);
        arquivo1.setTamanhoEmBytes("Conteudo teste Infraero".getBytes().length);
