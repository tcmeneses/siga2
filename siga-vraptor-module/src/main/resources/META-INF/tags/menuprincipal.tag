...
<li>
	<a href="javascript:void(0);"><i class="fa fa-th-large"></i> 
		<span class="nav-label"><fmt:message key="menu.titulo" /></span>
		<span class="fa arrow"></span>
	</a>
	<c:if test="${not empty f:resource('siga.pagina.inicial.url')}">
        <ul class="nav nav-second-level collapse" aria-expanded="false">
			<li><a href="/siga/app/principal?redirecionar=false">Quadros Quantitativos</a></li>
			<c:if test="${f:resource('siga.local') ne 'GOVSP'}">
				<li><a href="/siga/app/principal">Página
						Inicial</a></li>
			</c:if>
			<li>
				<ul class="nav nav-third-level collapse" aria-expanded="false">
					<a href="#">Módulos <span class="fa arrow"></span></a>
					<c:if
			...
			<c:if test="${f:resource('siga.local') eq 'GOVSP'}">
				<c:if test="${not empty f:resource('gsa.url')}">
					<li><a href="/siga/app/busca">Busca
							Textual</a></li>
				</c:if>
			</c:if>
			<li>
				<ul class="nav nav-third-level collapse" aria-expanded="false">
					<a href="#">Administração <span class="fa arrow"></span></a>
			...
			<c:if
				...
				<li>
					<ul class="nav nav-third-level collapse" aria-expanded="false">
						<a href="#">Gestão de Identidade <span class="fa arrow"></span></a>
						<c:if
						...
						<c:if
							...
							<li><a href="/siga/app/funcao/listar">Cadastro
						...
						<c:if
							...
							<li><a href="/siga/app/pessoa/listar">Cadastro
									de Pessoa</a></li>
						</c:if>
						<c:if
				...
				<li>
			        <ul class="nav nav-second-level collapse" aria-expanded="false">
						...
						<c:if
							...
							<li><a href="/siga/app/feriado/listar">Cadastro
									de Feriados</a></li>
						</c:if>
					</ul>
				</li>
			...
			<c:if test="${not empty meusTitulares}">
				<li>
					<ul class="nav nav-third-level collapse" aria-expanded="false">
						<a href="#">Substituir <span class="fa arrow"></span></a>
			...
			<li><a href="/siga/public/app/logout">Logoff</a></li>
		</ul>
	</c:if>
</li>
